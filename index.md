...
<h1>
    LOW LATENCY NEURAL DIRECTIONAL FILTERING WITH DIRECTIVITY PATTERN CONDITIONING FOR SPEECH ENHANCEMENT IN HEARING DEVICES
</h1>

<p>
    This is a test website to check if it is possible for me to add this to my IWAENC paper
</p>
...
<p>
    ...
    <audio controls>
        <source src="/Files/Clean/P3/sample1.wav" type="audio/wav">
...
<p>Select an audio file: &nbsp;&nbsp;
    <select id="audioSelect" onchange="playAudio()">
        <option value="P3/sample1">P3/sample1</option>
    <option value="P3/sample2">P3/sample2</option>
    </select>
</p>
...
<p>
    ...
    <audio id="audioPlayerNoisy" controls>
        <source id="audioSourceNoisy" src="../Files/Clean/P3/sample1.wav" type="audio/wav">
        Your browser does not support the audio element.
    </audio><br>

    FiLM-JNF-32ms <span class="reference" data-ref="FiLM-OSN-32ms"></span>:<br>
    <audio id="audioPlayerjnf32" controls>
        <source id="audioSourcejnf32" src="/informatik/sp/public/audio/publications/iwaenc2026-film-osn/Files/FiLM-JNF32ms/P3/sample1.wav" type="audio/wav">
        Your browser does not support the audio element.
    </audio><br>

    FiLM-JNF-8ms <span class="reference" data-ref="FiLM-JNF-8ms"></span>:<br>
    <audio id="audioPlayerosn" controls>
        <source id="audioSourceCDiffuSE" src="/informatik/sp/public/audio/publications/iwaenc2026-film-osn/Files/FiLM-JNF8ms/P3/sample1.wav" type="audio/wav">
        Your browser does not support the audio element.
    </audio><br>

    Clean: <br>
    <audio id="audioPlayerClean" controls>
        <source id="audioSourceClean" src="/informatik/sp/public/audio/publications/iwaenc2026-film-osn/Files/Clean/P3/sample1.wav" type="audio/wav">
        Your browser does not support the audio element.
    </audio>
</p>
...
<script>
    function playAudio() {
        ...
        var audioPlayerjnf32 = document.getElementById('audioPlayerjnf32');
        ...
        if (selectedAudio) {
            ...
            audioSourceNoisy.src = "/Files/Noisy/" + selectedAudio + ".wav";
            audioPlayerNoisy.load(); // Load the selected audio file using the audio player

            audioSourcejnf32.src = "/informatik/sp/public/audio/publications/iwaenc2026-film-osn/Files/FiLM-JNF32ms" + selectedAudio + ".wav";
            audioPlayerjnf32.load(); // Load the selected audio file using the audio player
